...
try:
    ...
    print(f"Could not automatically open files from Python script history directory. Please check manually. Error: {e}")
    write_log(f"Failed to auto-open files from Python script history directory: {main_output_xlsx}, {main_log_file}. Error: {e}")